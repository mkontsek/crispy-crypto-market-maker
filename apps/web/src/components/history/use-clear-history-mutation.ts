...
type DeleteHistoryResponse = {
  deleted: { fills: number; quotes: number; inventory: number; pnlSnapshots: number };
};
...
export function useClearHistoryMutation({ setFillsPage }: UseClearHistoryMutationProps) {
