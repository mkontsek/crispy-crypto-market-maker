...
export function persistPayload(botId: BotId, payload: EngineStreamPayload): void {
...
async function writeFills(botId: BotId, payload: EngineStreamPayload): Promise<void> {
...
async function writeQuotes(botId: BotId, payload: EngineStreamPayload): Promise<void> {
...
async function writeInventory(botId: BotId, payload: EngineStreamPayload): Promise<void> {
...
async function writePnl(botId: BotId, payload: EngineStreamPayload): Promise<void> {
  const p = payload.pnl;
