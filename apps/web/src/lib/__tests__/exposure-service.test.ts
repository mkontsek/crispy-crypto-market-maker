...
describe('buildExposureRows', () => {
  ...
  it('calculates notional and stress values', () => {
    const inventory = [{ pair: 'BTC/USDT' as const, inventory: '2', normalizedSkew: '0', timestamp: '0' }];
    const quotes = [{ pair: 'BTC/USDT' as const, bid: '0', ask: '0', mid: '50000', spreadBps: '0', inventorySkew: '0', quoteRefreshRate: '0', volatility: '0', paused: false, updatedAt: '' }];
  ...
  it('calculates pctOfLimit when config is provided', () => {
    const inventory = [{ pair: 'BTC/USDT' as const, inventory: '5', normalizedSkew: '0', timestamp: '0' }];
    const quotes = [{ pair: 'BTC/USDT' as const, bid: '0', ask: '0', mid: '1', spreadBps: '0', inventorySkew: '0', quoteRefreshRate: '0', volatility: '0', paused: false, updatedAt: '' }];
    const config = {
      pairs: [{ pair: 'BTC/USDT' as const, maxInventory: '10', baseSpreadBps: '10', volatilityMultiplier: '1', inventorySkewSensitivity: '0.5', quoteRefreshIntervalMs: 500, hedgeThreshold: '5', hedgeExchange: 'Binance' as const, enabled: true, hedgingEnabled: true }],
    };
