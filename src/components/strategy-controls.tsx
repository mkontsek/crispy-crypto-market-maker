        ...
        <div className="flex flex-col gap-4 rounded-xl border border-slate-800 bg-slate-900 p-4">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2 justify-between">
                    <div className="flex rounded-md border border-slate-700">
                        <button
                            className={cn(
                                'w-32 px-3 py-1.5 font-mono text-sm transition-colors',
                                orderSizeMode === 'fixed'
            ...
            <div className="flex flex-col gap-2">
                ...
                <Input
                    ...
                    onChange={(e) =>
                        setRebalanceThreshold(Number(e.target.value))
                    }
                    className="h-8 border-slate-700 bg-slate-950 font-mono text-xs text-slate-200"
                />
            </div>
            ...
            <div className="mt-2 flex flex-col gap-2 rounded-lg border border-neon-red/20 bg-neon-red/5 p-3">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-neon-red">
                        Kill Switch
                    </span>
                </div>
                <Button
                    className={cn(
                        'w-full font-mono text-sm font-bold tracking-widest transition-all',
                        killConfirm
