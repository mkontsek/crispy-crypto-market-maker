...
export function GlobalHeader() {
  const { mode, setMode, pnl24h, pnlPercent24h, inventory, wsLatency, wsConnected } =
    useBotStore();
      ...
      <div className="flex h-14 items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold tracking-wider text-slate-100">
            CRISPY <span className="text-electric-blue">MM</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-xs text-slate-500">
              Latency:{" "}
              <span className="text-slate-300">{wsLatency}ms</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-mono text-sm font-semibold text-neon-green">
              +${pnl24h.toLocaleString("en-US", { minimumFractionDigits: 2 })}
            </span>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-mono text-sm font-medium text-slate-200">
              ${inventory.toLocaleString("en-US", { minimumFractionDigits: 2 })} USDT
            </span>
          </div>
        </div>
